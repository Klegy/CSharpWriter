...
namespace DCSoft.CSharpWriter.Commands
{
    ...
    public class WriterCommandControler : Component, IExtenderProvider, System.ComponentModel.ISupportInitialize
    {
        /// <summary>
        /// 初始化对象
        /// </summary>
        ...
        public WriterCommandControler(IContainer c)
            : this()
        {
            if (c != null)
            {
        ...
        {
            if (extendee is WriterCommandControler
