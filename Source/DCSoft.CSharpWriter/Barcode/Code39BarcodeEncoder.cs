...
{
    internal class Code39BarcodeEncoder : BarcodeEncoder
    {
        private static System.Collections.Hashtable C39_Code = null;
        private static System.Collections.Hashtable ExtC39_Translation = null;
        ...
        public Code39BarcodeEncoder(string input)
        {
            Raw_Data = input;
        }//Code39
        ...
        public Code39BarcodeEncoder(string input, bool AllowExtended)
        {
            Raw_Data = input;
        ...
        private string Encode_Code39()
        {
            ...
            if (_AllowExtended)
            {
                FormattedData = InsertExtendedCharsIfNeeded(FormattedData);
            }
            ...
            foreach (char c in FormattedData)
            {
                ...
                {
                    base.ErrorMessage = BarcodeStrings.Code39InvaliData;
                    return null;
                }
            }//foreach
        ...
        private void init_Code39()
        {
            ...
            C39_Code = new System.Collections.Hashtable();
        ...
        {
            if (ExtC39_Translation != null)
                return;
            ExtC39_Translation = new System.Collections.Hashtable();
        ...
        private string InsertExtendedCharsIfNeeded(string FormattedData)
        {
            ...
            foreach (char c in Raw_Data)
            {
                ...
                else if (ExtC39_Translation.ContainsKey(c.ToString()))
                {
                    output.Append(ExtC39_Translation[c.ToString()].ToString());
                }
                else
                {
                    this.ErrorMessage = BarcodeStrings.Code39InvaliData;
                    return null;
                }
            }//foreach
