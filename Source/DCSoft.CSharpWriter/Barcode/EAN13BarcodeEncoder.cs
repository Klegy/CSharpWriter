...
{
    internal class EAN13BarcodeEncoder : BarcodeEncoder
    {
        ...
        public EAN13BarcodeEncoder(string input)
        {
            Raw_Data = input;
        }
        /// <summary>
        ...
        private string Encode_EAN13()
        {
            ...
            {
                base.ErrorMessage = BarcodeStrings.EAN13InvaliData;
                return null;
            }
            ...
            else if (CountryCodes.ContainsKey(twodigitCode))
            {
                _Country_Assigning_Manufacturer_Code = CountryCodes[twodigitCode].ToString();
            }
            else
            {
                base.ErrorMessage = BarcodeStrings.EAN13InvaliCountry;
                return null;
            }
            return result;
        }//Encode_EAN13
